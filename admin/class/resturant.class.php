...
class resturant extends common
{
	...
	{
		$sql ="insert into resturant(rest_id,rest_name,phone_no,email_id,date,status,delivery)values('$this->rest_id','$this->rest_name','$this->phone_no','$this->email_id','$this->date', $this->status,$this->delivery)";
