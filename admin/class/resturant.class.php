...
class resturant extends common
{
	...
	{
		$sql ="insert into resturant(rest_id,rest_name,phone_no,password,salt,email_id,date,status,open_time,close_time,delivery)values('$this->rest_id','$this->rest_name','$this->phone_no','$this->password','$this->salt','$this->email_id','$this->date','$this->status','$this->open_time','$this->close_time','$this->delivery')";
