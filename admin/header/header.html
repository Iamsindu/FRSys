...
<html>
    <head>
        ...
        <!-- <link rel="shortcut icon" href="assets/images/favicon.ico">    top-social-icon -->
            ...
            <div class="left side-menu">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.html" class="logo"><i class="mdi mdi-assistant"></i> FRSys</a>
                        ...
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="show_admin.html">Show Admin</a></li>
                                </ul>
                            </li>

                            <li>
                                <a href="#" class="waves-effect"><i class="fa fa-user-o"></i><span> User </span></a>
                                <li><a href="add_resturant.html">Add User</a></li>
                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="add_resturant.html">Add Restaurant</a></li>
                                    <li><a href="#">Add Restaurant Discount </a></li>
                                </ul>
                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="add_food_discount.html">Add Food Discount</a></li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="show_menu.html">Show Menu</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="show_category.html">Show Category</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="add_discount.html">Add Discount</a></li>
                                    <li><a href="show_discount.html">Show Discount</a></li>
                                </ul>
                            </li>
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-table"></i><span> Item </span> <span class="float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="add_similar_items.html">Add Item</a></li>
                                    <li><a href="add_special_item.html">Add Special Item</a></li>
                            ...
                            <li class="has_sub">
                                    ...
                                    <ul class="list-unstyled">
                                        <li><a href="show-bill.html">Show Bill</a></li>                                       
                                    </ul>
                                </li>
