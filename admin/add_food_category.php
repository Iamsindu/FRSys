                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <div class="form-group">    
                                            ...
                                            <select class="select2 form-control mb-3 custom-select" style="width: 100%; height:36px;" name="food_id">
                                                   ...
                                                   foreach ($datas as $values)
                                               {
                                                 ?>
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="<?php echo $a.$b;?>" data-parsley-multiple="groups"
                                                                    data-parsley-mincheck="2" value="<?php echo $values->cat_id; ?>" name="catt[]">
                                                            <label class="custom-control-label" for="<?php echo $a.$b;?>"><?php echo $values->catname; ?></label>
                                                        </div>
